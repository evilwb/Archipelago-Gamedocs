...
const exportOptions = () => {
  ...
  switch (preset) {
    case '__default':
      options['description'] = `Generated by https://evilwb.hopto.org with the default preset.`;
      break;

    case '__custom':
      options['description'] = `Generated by https://evilwb.hopto.org.`;
      break;

    default:
      options['description'] = `Generated by https://evilwb.hopto.org with the ${preset} preset.`;
  }
